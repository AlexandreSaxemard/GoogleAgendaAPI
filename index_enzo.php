...
<body>
    <div class="container">
        <br />
        <h2 style="text-align: center;">Connexion Google en PHP</h2>
        <br />
...
if (isset($_POST['submit'])) {
    ...
    if (empty($valErr)) {
        ...
        if (!empty($_SESSION['access_token'])) {
            ...
            $data = $GoogleCalendarApi->GetAccessToken($clientID, $redirectUri, $clientSecret, $_GET['code']);
        ...
        if (!empty($_SESSION['access_token'])) {
            try {
                ...
                $user_timezone = $GoogleCalendarApi->GetUserCalendarTimezone($_SESSION['access_token']);
                // Create an event on the primary calendar 
                $google_event_id = $GoogleCalendarApi->CreateCalendarEvent($_SESSION['access_token'], 'primary', $calendar_event, 0, $event_datetime, $user_timezone);
